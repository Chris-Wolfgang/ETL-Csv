...
namespace Wolfgang.Etl.Csv.Tests.SourceLink;

public class SourceLinkPdbTests
{
    private const string RepoSlug = "Chris-Wolfgang/ETL-Csv";


    private const string RuntimePdbFileName = "Wolfgang.Etl.Csv.pdb";
